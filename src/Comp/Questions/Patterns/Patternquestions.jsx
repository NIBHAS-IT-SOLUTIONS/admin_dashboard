...
<div className="options">
          <div className="option">
            <input
              ...
              name="option"
              value="sdgsbd"
            />{<img width="60" height="60" src={`data:image/jpeg;base64,${pquestion.a}`} alt="Base64 Image" />}
            <input
              type="radio"
              name="option"
              value="sdgsbd"
            />{<img width="60" height="60" src={`data:image/jpeg;base64,${pquestion.b}`} alt="Base64 Image" />}
            <input
              type="radio"
              name="option"
              value="sdgsbd"
            />{<img width="60" height="60" src={`data:image/jpeg;base64,${pquestion.c}`} alt="Base64 Image" />}
            <input
              type="radio"
              name="option"
              value="sdgsbd"
            />{<img width="60" height="60" src={`data:image/jpeg;base64,${pquestion.d}`} alt="Base64 Image" />}
